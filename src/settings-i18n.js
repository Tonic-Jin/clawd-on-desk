...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      usageGaugeTitle: "Usage",
      usageGaugeSubtitle: "Show Codex and Claude usage limits near the pet.",
      usageGaugeSectionGeneral: "Display",
      usageGaugeSectionLimits: "Limits",
      usageGaugeEnabled: "Enable usage gauge",
      usageGaugeEnabledDesc: "Show live usage limits when provider data is available.",
      usageGaugeProvider_codex: "Codex",
      usageGaugeProvider_codex_desc: "Read Codex usage limits.",
      usageGaugeProvider_claude: "Claude",
      usageGaugeProvider_claude_desc: "Read Claude usage limits.",
      usageGaugePosition: "Position",
      usageGaugePositionDesc: "Choose where the gauge follows the pet.",
      usageGaugePosition_below: "Below",
      usageGaugePosition_above: "Above",
      usageGaugePosition_floating: "Floating",
      usageGaugePinnedLimits: "Pinned limits",
      usageGaugePinnedLimitsDesc: "Limits that stay visible in compact mode. Up to 4.",
      usageGaugeExpandedLimits: "Expanded limits",
      usageGaugeExpandedLimitsDesc: "Limits shown when the gauge is expanded.",
      usageGaugePollInterval: "Poll interval",
      usageGaugePollIntervalDesc: "How often Clawd refreshes usage data.",
      usageGaugeSeconds: "sec",
      usageGaugeLimit_codex_primary: "Codex primary",
      usageGaugeLimit_claude_five_hour: "Claude 5-hour",
      usageGaugeLimit_codex_secondary: "Codex secondary",
      usageGaugeLimit_claude_seven_day: "Claude 7-day",
      usageGaugeLimit_claude_seven_day_opus: "Claude 7-day Opus",
      usageGaugeLimit_claude_seven_day_sonnet: "Claude 7-day Sonnet",
      sidebarSoon: "Soon",
    ...
    zh: {
      ...
      usageGaugeTitle: "用量",
      usageGaugeSubtitle: "在桌宠附近显示 Codex 和 Claude 的用量限制。",
      usageGaugeSectionGeneral: "显示",
      usageGaugeSectionLimits: "限制",
      usageGaugeEnabled: "启用用量仪表",
      usageGaugeEnabledDesc: "当 provider 数据可用时显示实时用量限制。",
      usageGaugeProvider_codex: "Codex",
      usageGaugeProvider_codex_desc: "读取 Codex 用量限制。",
      usageGaugeProvider_claude: "Claude",
      usageGaugeProvider_claude_desc: "读取 Claude 用量限制。",
      usageGaugePosition: "位置",
      usageGaugePositionDesc: "选择仪表跟随桌宠的位置。",
      usageGaugePosition_below: "下方",
      usageGaugePosition_above: "上方",
      usageGaugePosition_floating: "浮动",
      usageGaugePinnedLimits: "固定显示的限制",
      usageGaugePinnedLimitsDesc: "紧凑模式下始终显示的限制，最多 4 项。",
      usageGaugeExpandedLimits: "展开显示的限制",
      usageGaugeExpandedLimitsDesc: "仪表展开后显示的限制。",
      usageGaugePollInterval: "轮询间隔",
      usageGaugePollIntervalDesc: "Clawd 刷新用量数据的频率。",
      usageGaugeSeconds: "秒",
      usageGaugeLimit_codex_primary: "Codex primary",
      usageGaugeLimit_claude_five_hour: "Claude 5 小时",
      usageGaugeLimit_codex_secondary: "Codex secondary",
      usageGaugeLimit_claude_seven_day: "Claude 7 天",
      usageGaugeLimit_claude_seven_day_opus: "Claude 7 天 Opus",
      usageGaugeLimit_claude_seven_day_sonnet: "Claude 7 天 Sonnet",
      sidebarSoon: "待推出",
    ...
    "zh-TW": {
      ...
      usageGaugeTitle: "用量",
      usageGaugeSubtitle: "在桌寵附近顯示 Codex 和 Claude 的用量限制。",
      usageGaugeSectionGeneral: "顯示",
      usageGaugeSectionLimits: "限制",
      usageGaugeEnabled: "啟用用量儀表",
      usageGaugeEnabledDesc: "當 provider 資料可用時顯示即時用量限制。",
      usageGaugeProvider_codex: "Codex",
      usageGaugeProvider_codex_desc: "讀取 Codex 用量限制。",
      usageGaugeProvider_claude: "Claude",
      usageGaugeProvider_claude_desc: "讀取 Claude 用量限制。",
      usageGaugePosition: "位置",
      usageGaugePositionDesc: "選擇儀表跟隨桌寵的位置。",
      usageGaugePosition_below: "下方",
      usageGaugePosition_above: "上方",
      usageGaugePosition_floating: "浮動",
      usageGaugePinnedLimits: "固定顯示的限制",
      usageGaugePinnedLimitsDesc: "精簡模式下一直顯示的限制，最多 4 項。",
      usageGaugeExpandedLimits: "展開顯示的限制",
      usageGaugeExpandedLimitsDesc: "儀表展開後顯示的限制。",
      usageGaugePollInterval: "輪詢間隔",
      usageGaugePollIntervalDesc: "Clawd 重新整理用量資料的頻率。",
      usageGaugeSeconds: "秒",
      usageGaugeLimit_codex_primary: "Codex primary",
      usageGaugeLimit_claude_five_hour: "Claude 5 小時",
      usageGaugeLimit_codex_secondary: "Codex secondary",
      usageGaugeLimit_claude_seven_day: "Claude 7 天",
      usageGaugeLimit_claude_seven_day_opus: "Claude 7 天 Opus",
      usageGaugeLimit_claude_seven_day_sonnet: "Claude 7 天 Sonnet",
    ...
    ko: {
      ...
      usageGaugeTitle: "사용량",
      usageGaugeSubtitle: "펫 주변에 Codex와 Claude 사용량 제한을 표시합니다.",
      usageGaugeSectionGeneral: "표시",
      usageGaugeSectionLimits: "제한",
      usageGaugeEnabled: "사용량 게이지 켜기",
      usageGaugeEnabledDesc: "provider 데이터가 있을 때 실시간 사용량 제한을 표시합니다.",
      usageGaugeProvider_codex: "Codex",
      usageGaugeProvider_codex_desc: "Codex 사용량 제한을 읽습니다.",
      usageGaugeProvider_claude: "Claude",
      usageGaugeProvider_claude_desc: "Claude 사용량 제한을 읽습니다.",
      usageGaugePosition: "위치",
      usageGaugePositionDesc: "게이지가 펫을 따라갈 위치를 선택합니다.",
      usageGaugePosition_below: "아래",
      usageGaugePosition_above: "위",
      usageGaugePosition_floating: "플로팅",
      usageGaugePinnedLimits: "고정 제한",
      usageGaugePinnedLimitsDesc: "컴팩트 모드에서 항상 보이는 제한입니다. 최대 4개.",
      usageGaugeExpandedLimits: "확장 제한",
      usageGaugeExpandedLimitsDesc: "게이지를 펼쳤을 때 보이는 제한입니다.",
      usageGaugePollInterval: "폴링 간격",
      usageGaugePollIntervalDesc: "Clawd가 사용량 데이터를 새로고침하는 주기입니다.",
      usageGaugeSeconds: "초",
      usageGaugeLimit_codex_primary: "Codex primary",
      usageGaugeLimit_claude_five_hour: "Claude 5시간",
      usageGaugeLimit_codex_secondary: "Codex secondary",
      usageGaugeLimit_claude_seven_day: "Claude 7일",
      usageGaugeLimit_claude_seven_day_opus: "Claude 7일 Opus",
      usageGaugeLimit_claude_seven_day_sonnet: "Claude 7일 Sonnet",
      sidebarSoon: "예정",
    ...
    ja: {
      ...
      usageGaugeTitle: "使用量",
      usageGaugeSubtitle: "ペットの近くに Codex と Claude の使用量制限を表示します。",
      usageGaugeSectionGeneral: "表示",
      usageGaugeSectionLimits: "制限",
      usageGaugeEnabled: "使用量ゲージを有効化",
      usageGaugeEnabledDesc: "provider データが利用できるときにリアルタイムの使用量制限を表示します。",
      usageGaugeProvider_codex: "Codex",
      usageGaugeProvider_codex_desc: "Codex の使用量制限を読み取ります。",
      usageGaugeProvider_claude: "Claude",
      usageGaugeProvider_claude_desc: "Claude の使用量制限を読み取ります。",
      usageGaugePosition: "位置",
      usageGaugePositionDesc: "ゲージがペットを追従する位置を選びます。",
      usageGaugePosition_below: "下",
      usageGaugePosition_above: "上",
      usageGaugePosition_floating: "フローティング",
      usageGaugePinnedLimits: "固定表示する制限",
      usageGaugePinnedLimitsDesc: "コンパクト表示で常に見える制限です。最大 4 件。",
      usageGaugeExpandedLimits: "展開表示する制限",
      usageGaugeExpandedLimitsDesc: "ゲージを展開したときに表示する制限です。",
      usageGaugePollInterval: "ポーリング間隔",
      usageGaugePollIntervalDesc: "Clawd が使用量データを更新する頻度です。",
      usageGaugeSeconds: "秒",
      usageGaugeLimit_codex_primary: "Codex primary",
      usageGaugeLimit_claude_five_hour: "Claude 5 時間",
      usageGaugeLimit_codex_secondary: "Codex secondary",
      usageGaugeLimit_claude_seven_day: "Claude 7 日",
      usageGaugeLimit_claude_seven_day_opus: "Claude 7 日 Opus",
      usageGaugeLimit_claude_seven_day_sonnet: "Claude 7 日 Sonnet",
      sidebarSoon: "近日対応",
